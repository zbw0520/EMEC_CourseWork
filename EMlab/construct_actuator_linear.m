...
mi_addblocklabel(10,0);
mi_selectlabel(10,0);
mi_setblockprop('core_linear',automesh_block,meshsize_block,'<None>',magdir_block,corep(1,3),0);%set winding to zero
mi_clearselected();
%--------add block label to the actuator--------
mi_addblocklabel(70,0);
mi_selectlabel(70,0);
mi_setblockprop('core_linear',automesh_block,meshsize_block,'<None>',magdir_block,moverp(1,3),0);%set winding to zero
mi_clearselected();
